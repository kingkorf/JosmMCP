...
import org.openstreetmap.josm.plugins.josmmcp.tools.ReverseWay;
...
import org.openstreetmap.josm.plugins.josmmcp.tools.SplitWay;
...
public final class ToolRegistry {
	...
	public static List<BaseTool> all() {
		...
		t.add(new InsertNodeInWay());
		t.add(new SplitWay());
		t.add(new ReverseWay());
